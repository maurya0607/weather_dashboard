...
//   // ALL hourly params from single forecast/archive endpoint
//   const weatherHourly = [
//     'temperature_2m',
//     'relative_humidity_2m',
//     'precipitation_probability',
...
//   } else if (selDate === t) {
//     // TODAY → forecast with live current block
//     const { data } = await axios.get(`${METEO_BASE}/forecast`, {
//       params: {
//         latitude:  lat,
//         longitude: lon,
...
// // ── 3. 7-day forecast for WeatherCard ────────────────────────
// export async function fetchWeekForecast(lat, lon) {
//   const { data } = await axios.get(`${METEO_BASE}/forecast`, {
//     params: {
//       latitude:      lat,
...
// // Uses ONLY archive endpoint — no separate AQ API needed
// // pm10, pm2_5, carbon_monoxide, nitrogen_dioxide, sulphur_dioxide
// // are available as HOURLY params in archive endpoint
// export async function fetchHistoricalWeather(lat, lon, startDate, endDate) {

//   // Clamp end date — archive has ~5 day processing lag
...
//         'wind_direction_10m_dominant',
//       ].join(','),
//       // Hourly AQ — will be aggregated to daily below
//       hourly: [
//         'pm10',
//         'pm2_5',
//         'carbon_monoxide',
...
//   // Aggregate hourly AQ → daily mean
//   // Archive doesn't provide daily AQ directly
